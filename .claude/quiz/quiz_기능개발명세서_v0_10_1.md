...
> **버전:** v0.10.1 · **상태:** 초안 — 본문 = 현행 13유형(8유형 + 안 보이는 나무 6종, minmax·hidden 통합) · **최종 수정일:** 2026-08-17
...
### 3.6.2 조작 H-c·H-d  ⭐ (H군 v0.10.1 · `type:'manip'`)

| sub | 이름 | 제시(`given.kind`) | 질문 | 서버 계산 | 지원 등급 |
|---|---|---|---|---|---|
| **H-c** | 정육면체 완성 | `isoTop` | 더 필요한 나무 수 | `manip.completeCube` | 중~최상 |
| **H-d** | 색칠한 정육면체 | `paintedCube` | k면 색칠된 나무 수 | `manip.paintedCubeCount` | 중~최상 |
