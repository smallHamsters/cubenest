...
> **버전:** v0.14.0 · **상태:** 초안 — 본문 = 현행 **19유형**(계산 3 + 위앞옆 3 + G군 3 + A군 6 + H군 4) · **최종 수정일:** 2026-08-21
> **기준 마스터:** v1.9.2 (§5.2 클라↔서버 복본 동기화 · §6.7 정답 은닉 규약 · §1 연령 스테이지)
> ⚠ **마스터 §9 인덱스는 아직 v0.11.2 로 적혀 있다** — 마스터는 별도 관리라 이번 갱신에서 건드리지 않았다. 마스터를 손볼 때 함께 올린다.
