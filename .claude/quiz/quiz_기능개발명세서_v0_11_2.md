...
> **버전:** v0.13.0 · **상태:** 초안 — 본문 = 현행 **19유형**(계산 3 + 위앞옆 3 + G군 3 + A군 6 + H군 4) · **최종 수정일:** 2026-08-21
