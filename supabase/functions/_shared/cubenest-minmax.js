 ...
 *     클라 사본 assets/js/cubenest-minmax.js 는 어떤 페이지도 로드하지 않는 죽은 사본이라 삭제했다.
 *     UMD 형태는 유지 — 클라가 다시 필요해지면 이 파일을 assets/js/ 로 올려 정본으로 삼고,
 *     여기엔 '원문 + export 꼬리' 복본을 두면 된다(§5.2 규칙 1~3).
